...
// 1. Update hero title and breadcrumb
content = content.replace(
    '<h1 class="elementor-heading-title elementor-size-default">Make An Appointment</h1>',
...
// 2. Find the bounds for the content replacement
const replaceStartStr = '<div class="elementor-element elementor-element-aea2126';
const replaceEndStr = '<div class="ekit-template-content-markup ekit-template-content-footer';

const startIndex = content.indexOf(replaceStartStr);
const endIndex = content.indexOf(replaceEndStr);

if (startIndex !== -1 && endIndex !== -1) {
    const newContent = `
<div class="elementor-element e-con-full e-flex e-con e-parent" style="background-color: #fcfcfc; padding: 60px 0;">
  <div class="container my-5">
    ...
    <div class="row align-items-stretch mb-5 bg-white shadow-sm overflow-hidden" style="border-radius: 20px !important;">
      <div class="col-md-6 p-0 d-flex align-items-center justify-content-center bg-white" style="min-height: 400px;">
      ...
      <div class="col-md-6 p-5 text-white" style="background: linear-gradient(135deg, #1fa2ff 0%, #12d8fa 50%, #1793d1 100%); display: flex; flex-direction: column; justify-content: center; position: relative;">
        ...
        <div style="position: relative; z-index: 2;">
            <h2 class="mb-4 text-white" style="font-weight: 600; font-size: 2.5rem; color: #ffffff !important;">Work With Us</h2>
            <p style="font-size: 16px; line-height: 1.8; margin-bottom: 0; color: rgba(255, 255, 255, 0.95) !important;">
    ...
    <div class="row mt-5">
      ...
      <div class="col-md-6 pe-md-5 d-flex flex-column justify-content-center">
        ...
        <div class="mt-5 text-center position-relative">
          ...
          <img src="/assets/uploads/images/careers_life_impact.png" alt="Life at Impact" style="width: 100%; max-width: 400px; border-radius: 50% 50% 50% 50% / 60% 60% 40% 40%; box-shadow: 0 15px 35px rgba(0,0,0,0.15); position: relative; z-index: 1;">
        </div>
      </div>
      ...
      <div class="col-md-6 mt-5 mt-md-0">
        <div class="card shadow-lg border-0 p-5" style="border-radius: 20px !important; background-color: #fff;">
          <div class="card-body p-0">
            <h2 class="text-center mb-3" style="color: #000; font-weight: 600; font-size: 2.2rem;">Current Openings</h2>
            <p class="text-center mb-5 text-muted" style="font-size: 15px;">For current openings email us on:</p>
            ...
            <form action="#" method="post" enctype="multipart/form-data">
              ...
              <button type="submit" class="btn w-100 py-3 text-white mt-3" style="background-color: #1a73e8; font-weight: 600; border-radius: 8px; font-size: 16px; transition: background-color 0.3s; border: none;">Send message</button>
            </form>
          </div>
        </div>
      </div>
...
`;
    ...
    console.log('Could not find start or end bounds in the HTML.');
}
